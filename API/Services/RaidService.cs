...
public class RaidService : IRaidService
{
    ...
    public async Task<List<DPS>> GetDPSByHighestDamage(DPS dps) => await _dpsRepository.GetDPSByHighestDamage(dps);
    ...
    public async Task<List<Healer>> GetHealerByHealingAmount(Healer healer) => await _healerRepository.GetHealerByHealingAmount(healer);
    ...
    public async Task<List<Tank>> GetTankByHighestArmour(Tank tank) => await _tankRepository.GetTankByHighestArmour(tank);
